...
void ::MicrosoftStore::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::MicrosoftStore::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::MicrosoftStore::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
